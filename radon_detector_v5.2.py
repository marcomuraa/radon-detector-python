...
class Toplevel1:
    ...
    def show_image(self, top=None):
        ...
        #photo = ImageTk.PhotoImage(image = Image.fromarray( np.asarray( np.clip(rholes_array[i],0,255), dtype="uint8"), "L" ))
    ...
    def detect(self, top=None):
        ...
        for filename in os.listdir(path_to_image):
            ...
            #image = Image.open(os.path.join(path_to_image, filename))
